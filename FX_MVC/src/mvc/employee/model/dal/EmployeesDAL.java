...
public class EmployeesDAL {
	...
	public int updateEmployee(Employee emp) {
		try (Statement statement = OraConn.getConnection().createStatement();) {
			...
			String query = "UPDATE EMPLOYEES SET " + "LAST_NAME = '" + emp.getLastName() + "', " + "FIRST_NAME = '"
					+ emp.getFirstName() + "', " + "EMAIL = '" + emp.getEmail() + "', " + "JOB_ID = '" + emp.getJobId()
					+ "', " + "PHONE_NUMBER = '" + emp.getPhoneNumber() + "', " + "HIRE_DATE = to_date('" + hireDate
					+ "', 'yyyyMMdd') , " + "DEPARTMENT_ID = " + emp.getDepartmentId() + " , " + "MANAGER_ID = "
					+ emp.getManagerId() + " , " + "SALARY = " + emp.getSalary() + " " + "WHERE " + "EMPLOYEE_ID 	= "
					+ emp.getEmployeeId();
			int affectedRows = statement.executeUpdate(query);
